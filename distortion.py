def distortion(row_1, row_2):
    ...
    ###888
    native_country_d = {
        'Cambodia': 4, 'India': 4, 'Japan': 4, 'China': 4, 'Iran': 4, 'Philippines': 4, 'Vietnam': 4, 'Laos': 4, 'Taiwan': 4, 'Thailand': 4, 'Hong': 4, 'England': 4, 'Germany': 4, 'Greece': 4, 'Italy': 4, 'Poland': 4, 'Portugal': 4, 'Ireland': 4, 'France': 4, 'Hungary': 4, 'Scotland': 4, 'Yugoslavia': 4, 'Holand-Netherlands': 4, 'United-States': 4, 'Puerto-Rico': 4, 'Canada': 4, 'Outlying-US(Guam-USVI-etc)': 4, 'Cuba': 4, 'Honduras': 4, 'Jamaica': 4, 'Mexico': 4, 'Dominican-Republic': 4, 'Ecuador': 4, 'Haiti': 4, 'Columbia': 4, 'Guatemala': 4, 'Nicaragua': 4, 'El-Salvador': 4, 'Trinadad&Tobago': 4, 'Peru': 4, 'South': 4,
        'asia': 3, 'europe': 3, 'america': 3, 'oceania': 3,
        'asia_oce': 2, 'eur_ame': 2,
        '*': 1}
    native_country_generalization = {
        'Cambodia': 'asia', 'India': 'asia', 'Japan': 'asia', 'China': 'asia', 'Iran': 'asia', 'Philippines': 'asia', 'Vietnam': 'asia', 'Laos': 'asia', 'Taiwan': 'asia', 'Thailand': 'asia', 'Hong': 'asia',
        'England': 'europe', 'Germany': 'europe', 'Greece': 'europe', 'Italy': 'europe', 'Poland': 'europe', 'Portugal': 'europe', 'Ireland': 'europe', 'France': 'europe', 'Hungary': 'europe', 'Scotland': 'europe', 'Yugoslavia': 'europe', 'Holand-Netherlands': 'europe',
        'United-States': 'america', 'Puerto-Rico': 'america', 'Canada': 'america', 'Outlying-US(Guam-USVI-etc)': 'america', 'Cuba': 'america', 'Honduras': 'america', 'Jamaica': 'america',
        'Mexico': 'america', 'Dominican-Republic': 'america', 'Ecuador': 'america', 'Haiti': 'america', 'Columbia': 'america', 'Guatemala': 'america', 'Nicaragua': 'america', 'El-Salvador': 'america', 'Trinadad&Tobago': 'america', 'Peru': 'america',
        'South': 'oceania',
    ...
    #print(c_distortion)
    distortion_c1_c2 = round(sum(c_distortion), 4)
    return distortion_c1_c2
